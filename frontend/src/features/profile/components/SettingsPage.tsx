      ...
      <main className="settings-main-content">
        <div className="max-width-container">
          <header className="settings-header">
            <h1 className="display-title">{language === 'es' ? 'Perfil del Pastor' : 'Pastor Profile'}</h1>
            <p className="subtitle-text">
              {language === 'es' 
                ? 'Configure su identidad ministerial para una experiencia personalizada.' 
                : 'Configure your ministerial identity for a personalized experience.'}
            </p>
          </header>
          ...
          <div className="settings-grid-layout">
            ...
            <section className="glass-card-settings">
              ...
              <h2 className="headline-text">{language === 'es' ? 'Información del Perfil' : 'Profile Information'}</h2>
              ...
              <div className="form-grid-settings">
                ...
                <div className="input-group-sacred">
                  ...
                  <input 
                    ...
                    onChange={(e) => setProfile({...profile, ministry_name: e.target.value})}
                  />
                </div>
                ...
                <div className="input-group-sacred">
                  ...
                  >
                    <option value="encouraging">{language === 'es' ? 'Homilético (Alentador)' : 'Homiletic (Encouraging)'}</option>
                    <option value="academic">{language === 'es' ? 'Académico (Exegético)' : 'Academic (Exegetical)'}</option>
                    <option value="practical">{language === 'es' ? 'Práctico (Aplicación)' : 'Practical (Application)'}</option>
                  </select>
                </div>
              ...
              <div className="actions-footer-settings">
                <button className="btn-save-sacred" onClick={handleSave} disabled={saving}>
                  {saving ? '...' : (language === 'es' ? 'Guardar Ajustes' : 'Save Settings')}
                </button>
              </div>
            </section>
          </div>
