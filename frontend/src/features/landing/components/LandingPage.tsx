    ...
    <div className="landing-container-new">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-content-new">
              ...
              <div className="hero-actions-new">
                <Button size="lg" className="cta-primary" onClick={() => navigate('/register')}>
                  {t('hero.cta_free')}
                </Button>
              </div>
            </div>
          ...
          <div className="faq-list">
            {faqs.map((faq, i) => (
              <div key={i} className="faq-item">
                ...
                {faq.a && <div className="faq-answer">{faq.a}</div>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="final-cta-section">
        <div className="max-w-narrow">
          ...
          <Button size="lg" className="cta-huge" onClick={() => navigate('/register')}>
            {t('btn.start_free')}
          </Button>
        </div>
      </section>
